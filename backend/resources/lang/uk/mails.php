...
return [
    ...
    'order_paid' => [
        'subject' => 'Оплату за замовлення отримано!',
        'greeting' => 'Вітаємо, :name',
    ...
    'order_shipped' => [
        'subject' => 'Ваше замовлення вже в дорозі!',
        'greeting' => 'Вітаємо, :name',
        'shipped' => 'Ваше замовлення відправлено!',
        'tracking_number' => 'Номер відстеження',
        'track_order_button' => 'Відстежити замовлення за посиланням',
        'order_number' => 'Номер замовлення',
        'thanks' => 'З повагою',
    ]
];
