...
const CARRIERS: Record<string, Carrier> = {
    ...
    posten_norge: {
        id: "posten_norge",
        logo: "/carriers/posten_norge.svg",
    },
    posturinn: {
        id: "posturinn",
        logo: "/carriers/posturinn.svg",
    },
    canada_post: {
        id: "canada_post",
        logo: "/carriers/canada_post.svg",
    },
    purolator: {
        id: "purolator",
    ...
    nz_post: {
        id: "nz_post",
        logo: "/carriers/nz_post.png",
    },
    pbt: {
        id: "pbt",
        logo: "/carriers/pbt.svg",
    },
    post_haste: {
        id: "post_haste",
        logo: "/carriers/post_haste.svg",
    },
};
...
const COUNTRY_CARRIERS: Record<string, string[]> = {
    ...
    NZ: ["nz_post", "pbt", "aramex", "post_haste"],
};
